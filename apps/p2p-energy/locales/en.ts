const en: { [key: string]: string } = {
  ...
  orderId: 'Order id',
  forAll: 'for All',
  subText: 'peer-to-peer (P2P) energy trading platform',
  ...
  noProduct: 'There are no items available in this category at the moment. Please check back soon for updates!'
}
export default en
