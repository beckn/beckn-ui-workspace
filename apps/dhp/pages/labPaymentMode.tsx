...
function labPaymentMode() {
  ...
  return (
    <>
      <Box height={'72vh'} position={'relative'} mt={5}>
        ...
        <CardWithCheckBox setChecked={setChecked} paymentMethod={t.cash} />
      </Box>
      <Box position={'absolute'} bottom={'10px'} width={'90%'}>
        <Button
          ...
          handleOnClick={() => {
            ...
            router.push('/orderConfirmationForLab')
          }}
        />
      </Box>
    </>
