  ...
  return (
    <Box className="hideScroll" maxH={'calc(100vh - 100px)'} overflowY="scroll">
        ...
        <DetailsCard>
          <Box>
            <Flex mb={'15px'} fontSize={'17px'} alignItems={'center'}>
              ...
              <Text textOverflow={'ellipsis'} overflow={'hidden'} whiteSpace={'nowrap'} fontWeight={600}>
            ...
            <Text fontSize={'12px'} fontWeight={'400'} pt={'5px'}>
      ...
      <DetailsCard>
        ...
        <Flex mt={'15px'} justifyContent={'space-between'} alignItems={'center'} fontSize={'17px'} fontWeight={'600'}>
          <Text>{t.total}</Text>
