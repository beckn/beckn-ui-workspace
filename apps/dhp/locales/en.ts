const en: { [key: string]: string } = {
  ...
  confirmingOrderLoader: 'while we confirm your appointment',
  ...
  errorDOB1: 'Please use the DD/MM/YYYY format',
  ...
  confirmMessage1: 'Your appointment has been booked',
  ...
  doctorCatalogLoader: 'while we look for doctors near you',
  ...
  completed: 'Completed',
  homeHeading: 'Portable Healthcare',
  headingSpan: 'for All',
  homeText:
    'an integrated solution that encompasses consulting with doctors, scheduling appointments, procuring medications, and locating nearby diagnostic laboratories for tests.',
