...
import LabPageActions from './LabPageActions'
...
const LabImageSection: React.FC<Props> = ({ imgArray, product }) => {
  ...
  return (
    <div className="flex items-start rounded-lg w-full md:w-auto" style={{ marginBottom: '20px' }}>
      <LabPageActions product={product} />
...
export default LabImageSection
