...
import CallToActionMedicine from './CallToActionMedicine'
...
const DetailsSectionMedicine: React.FC<Props> = ({ product }) => {
  const { t } = useLanguage()
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start flex-wrap relative ">
        ...
        <CallToActionMedicine product={product} />
      </div>
    </Box>
  )
}

export default DetailsSectionMedicine
