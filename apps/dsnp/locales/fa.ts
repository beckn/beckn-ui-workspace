const fa: { [key: string]: string } = {
  ...
  accessToProvideLocation: "Veuillez fournir la permission d'accéder à une livraison meilleure et sans tracas.",
  searchforlocation: 'Rechercher un emplacement',
  shopBtn: 'Boutique',
  cartEmpty: 'Le panier est vide',
  cartEmptySpan: 'On dirait que tu n`as pas encore fait ton choix',
  importedOrder: 'Commande importée',
  importedOrderDetails1: 'Vous semblez avoir passé une commande pour',
  importedOrderDetails2: 'Souhaitez-vous acheter des articles liés à cette commande ?',
  viewOrderDetails: 'Voir d`autres détails',
  yesShowmethelist: 'Oui! Montre-moi la liste',
  NoIhaveeverythingIneed: 'Non, j`ai tout ce dont j`ai besoin',
  bookedon: 'Réservé le',
  noofTravellers: 'Nombre de voyageurs',
  totalPrice: 'Prix ​​total',
  goBack: 'Retourner',
  Pleasewait: "S'il vous plaît, attendez",
  loaderSubText: 'pendant que nous dressons une liste de courses détaillée pour vous !',
  shoppingList: 'Liste de courses',
  shoppingListSubText: 'Voici quelques éléments essentiels dont vous pourriez avoir besoin :',
  poweredby: 'Alimenté par',
  searchItems: 'Rechercher des articles',
  selectDeliveryLocation: 'Sélectionnez le lieu de livraison',
  cancel: 'Annuler',
  selectdelivery: 'Sélectionnez la livraison',
  selectdeliveryText: 'Où souhaitez-vous que la commande soit livrée ? '
}
export default fa
