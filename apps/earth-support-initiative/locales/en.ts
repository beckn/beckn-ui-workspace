const en: { [key: string]: string } = {
  ...
  errorPassword3: 'Password cannot consist of only digits',
  errorPassword4: 'Password must contain at least one uppercase letter',
  errorPassword5: 'Password must contain at least one special character',
  ...
  sharedViaChosenMode: 'Shared via chosen transfer mode'
}
export default en
