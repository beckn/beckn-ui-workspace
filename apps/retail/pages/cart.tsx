...
import { DataPerBpp, CartItemForRequest, ICartRootState, TransactionIdRootState, CartRetailItem } from '@lib/cart'
...
const Cart = () => {
  ...
  if (quoteRequest.loading || isLoadingForCartCountChange) {
    return <Loader text={t.quoteRequestLoader} />
  }
