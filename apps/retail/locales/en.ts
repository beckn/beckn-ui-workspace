const en: { [key: string]: string } = {
  ...
  statusLoaderSubText: 'while we fetch your order details',
  ...
  allRequestFullfilled: 'Order successfully delivered!',
  howTodo: 'Tell us how we did! ',
  ...
  fetchingTrackLoaderSubtext: 'Fetching the tracking and support details for your order.',
  updateOrderLoaderSubText: 'While we update your shipping details.',
  rateOrderLoaderSubText: 'While we submit your feedback',
  cancelLoaderSubText: 'While we process your request',
  signInwithGoogle: 'Sign In with Google',
  saveContinue: 'Save Changes',
  enterFlatDetails: ' Flat, House no, Building , etc',
  enterStreetDetails: ' Area , Street , Sector, Village',
  enterCity: ' City /Town',
