const en: { [key: string]: string } = {
  ...
  shareYourfeedback: 'Review the Service',
  submitReview: 'Submit Review',
  skipForNow: 'Go Back',
  claimError: 'Invalid Claim Valude',
  ...
  addBillingDetails: 'Add Respondent Details',
  addBillingDetails1: 'addBillingDetails',
  ...
  confirmMessage1: 'Navigate to the following ',
  confirmMessage2: 'to continue the order',
  ...
  confirmed: 'Confirmed',
  delivered: 'Delivered',
  confirmationPending: 'Case Submitted',
  itemsConfirmed: 'Case Accepted',
  orderPacked: 'Case in Progress',
  outForDelivery: 'Final Hearing',
  orderDelivered: 'Dispute Resolved',
  ...
  viewOrderDetails: 'View Case Details',
  ...
  complaintDetails: 'Complainant & Billing Details',
  addCompalintDetailsBtn: 'Add Complainant Details',
  addRespondentDetaislBtn: 'Add Respondent Details',
  addCompalintandBillingDetailsBtn: 'Add Complainant & Billing Details',
  disputeDetails: 'Dispute Details',
  addDisputeDetailsBtn: 'Add Dispute Details',
  claimValue: 'Claim Value (optional)',
  consent: 'Consent',
  fillConsentForm: 'Fill consent form',
  consentForm: 'Consent Form',
  caseManagerText: 'Your Case Manager has been assigned.',
  caseID: 'Case Id :',
  myCases: 'My Cases',
  disputeTextareaError: 'Add some input here',
  caseId: ' Case ID :',
  casesCatalogLoader: "We're looking for",
  services: 'services',
  relatedToYourSearches: 'related to your search',
  caseFormLoaderText: 'while we setup forms to',
  understandYourCase: 'understand your case in detail.',
  ...
  fetchingDetails: 'We are fetching details',
  ofOdrService: 'of the ODR service',
  by: 'by',
  estimatedSerivceFee: 'Estimated Service Fee',
  confirm: 'Confirm',
  save: 'Save',
  disputeDetailsAdded: 'Dispute details added',
  cancel: 'Cancel',
  i: 'I',
  termAndCondition: 'Term and Conditions',
  confirmThat: 'confirm that I’ve read and understand the terms of representation by',
  consentPara:
    'I agree to be represented in the described legal matter and acknowledge the fee structure, billing terms, and potential costs.I understand the attorney-client privilege and agree to communicate promptly and honestly. I’m aware of the conditions for terminating the relationship and its consequences.',
  hash: '#',
  submitted: 'Submitted!',
  providerLink: 'provider link',
  whileWeUpdate: 'while we update the current',
  statusOfOdr: 'status of your case.',
  allRequestFullfilled: 'All requests have been fulfilled!',
  howTodo: 'How did we do?',
  rateUs: 'Rate Us',
  complaintAndBilling: 'Complainant & Billing Details',
  added: 'Added'
}
export default en
