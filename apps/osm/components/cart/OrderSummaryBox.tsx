  ...
  return (
    <>
      {totalQuantity > 0 ? (
        ...
        >
          ...
          <div className="flex flex-col my-1 sm:my-2" style={{ fontSize: '15px' }}>
            <div className="flex items-center justify-between md:my-4">
              <p className="text-sm sm:text-base text-palette-mute md:text-palette-base">{t.totalQuantity}</p>
            ...
            <div className="flex flex-wrap items-baseline justify-between flex-grow md:my-4">
              <p className="text-sm sm:text-base text-palette-mute md:text-palette-base">{t.totalAmount}</p>
        ...
        <p className="text-palette-mute text-lg mx-auto mt-12">{t.cartIsEmpty}</p>
      )}
    </>
  )
}
