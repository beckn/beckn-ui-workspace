const fa: { [key: string]: string } = {
  ...
  optionStores: 'Magasins de commerce',
  optionHotels: 'Hôtels',
  optionBooks: 'Magasins de livres',
  ...
  delivery: 'Livraison',
  clickAndCollect: 'Cliquez et collectez',
  dineIn: 'Service sur place',
  takeAway: 'À emporte',
  bookstore: 'Librairie',
  formName: 'Nom',
  formNumber: 'Numéro de portable',
  ...
  completed: 'Complété',
  addShippingDetails: "Ajouter les détails de l'expédition",
  change: 'Changement',
  payment: 'Paiement',
  unableToLogin: 'Connection impossible',
  error: 'Erreur!',
  pleaseWait: 'Veuillez patienter!',
  searchLoaderSubText: 'Récupération du catalogue du magasin depuis le réseau',
  productAddedToCart: 'Produit ajouté au panier',
  selectLoaderSubText: 'pendant que nous récupérons les détails du produit sélectionné.',
  proceedTOCheckout: 'Passer à la caisse',
  sameAsShipping: 'Identique aux détails de la commande',
  initLoaderSubText: 'pendant que nous initialisons le projet de commande.',
  confirmLoaderSubtext: 'pendant que nous confirmons votre commande',
  orderSuccessfull: 'Commande confirmée!',
  thankYouForOrder: 'Merci ! Notre livreur va vous livrer votre commande',
  orderNumber: 'Le numéro de commande est',
  youCanTrack: 'Vous pouvez suivre votre commande dans la rubrique "Ma commande"',
  viewOrderDetails: 'Détails de la commande',
  goBackHome: "Retour à l'accueil",
  statusLoaderSubText: 'pendant que nous mettons à jour le statut actuel de votre commande.',
  orderOverview: 'Commande',
  invoiceDetails: 'Détails de la facture',
  placedAt: 'Placé à',
  fetchingTrackLoaderSubtext: "Pendant que nous récupérons les détails de suivi et d'assistance",
  updateOrder: 'Mise à jour de la commande',
  cancelOrder: 'Annuler la commande',
  callCustomer: 'Appeler le service client',
  emailCustomer: 'Service client par courrier électronique',
  merchantTakingTo: 'Le commerçant prend trop de temps',
  orderMistake: 'Commandé par erreur',
  iHaveChange: "J'ai changé d'avis",
  specifyReason: 'Veuillez préciser la raison',
  searchByLocation: 'Rechercher un magasin par emplacement',
  localeeOpen: 'Localee Open',
  yourLocation: "Sélectionnez l'emplacement",
  noAddressFound: 'Aucune adresse trouvée pour les coordonnées données.',
  homePara:
  ...
  orderHistoryIcon: 'Mes commandes',
  profileIcon: 'Mon profil',
  logoutIcon: 'Se déconnecter',
  saveContinue: 'Sauvegarder et continuer',
  enterFlatDetails: "Entrer le numéro d'appartement, de maison, d'immeuble, etc.",
  enterStreetDetails: 'Entrer le secteur, la rue, le quartier, le village',
  enterCity: 'Entrer la ville / village',
  enterPincode: 'Entrer le code postal',
  enterState: "Entrer l'état / la province",
  enterCountry: 'Entrer le pays',
  fullName: 'Entrez votre nom complet',
  enterMobileNumber: 'Entrer le numéro de portable',
  enterEmailID: "Entrer l'identifiant de messagerie électronique",
