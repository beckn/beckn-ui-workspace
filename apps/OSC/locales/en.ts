const en: { [key: string]: string } = {
  ...
  emailOrAddreessAlrteadyTaken: 'Email or Username are already taken',
  ...
  enabledrequest: 'Unable to proceed with init request',
  items: 'Items',
  saveShippingDetails: 'Save Shipping Details',
  saveBillingDetails: 'Save Billing Details',
  initializingInit: 'Initializing your request',
  orderSuccessfull: 'ORDER SUCCESFULL',
  thankYouForOrder: 'Thank you for your order!',
  orderNumber: 'Order number is',
  youCanTrack: 'You can track your order in "My Order" section',
  ...
  orderHasBeenCancelled: 'Your Order has been cancelled',
  refundedSoon: 'If you have already paid, you will be refunded soon.',
