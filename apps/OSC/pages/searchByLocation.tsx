...
const getStaticTags = (tag: string) => {
  ...
  else return ['inStoreShopping', 'delivery', 'clickAndCollect']
}
    ...
    >
      ...
      {!showSuggestions && (
        <>
          ...
          <div className="bottom-0 left-0 absolute z-[1000] max-h-fit w-[100vw]  flex items-end justify-center  sm:p-0">
            <Transition
              nodeRef={nodeRef}
              in={isMenuModalOpen}
              timeout={duration}
