const en: { [key: string]: string } = {
  ...
  SGST: 'Taxes (SGST)',
  items: 'Overview',
  shipping: 'Traveller Details',
  billing: 'Billing',
  changeText: 'Change',
  paymentText: 'Payment',
  orderDetailsCheckboxText: 'Same as Traveller Details',
  ...
  addShippingdetailsBtnText: 'Add Traveller Details',
  ...
  currencySymbol: '₹',
  saveShippingDetails: 'Save Traveller Details',
  ...
  errorName1: 'Name should be less than 100 character',
  ...
  errorEmail2: 'Invalid Email Id',
  errorAddress: 'Complete Address is required',
  errorZipcode: 'Zip code is required',
  errorZipcode2: 'Invalid Zip code',
  confirmMessage1: 'Thank you! Your booking will be',
  confirmMessage2: 'confirm shortly!',
  ...
  catalogSubLoader: 'Searching for things to do in',
  ...
  shop: 'Shop',
  date: 'Date:',
  searchForTravelLocation: 'Search For Travel Location',
  or: 'OR',
  cardNumber: '**** **** **** 1234',
  payment: 'Payment',
  name: 'Name',
  ...
  cancel: 'Cancel',
  numberOfTraveller: 'No Of Traveller',
  item: 'Items',
  addTravellerDetails: 'Add Traveller Details',
  travellerDetails: 'Traveller Details',
  saveTravellerDetails: 'Save Traveller Details',
  ...
  confirmMessage: 'Thank you! Your booking will be confirm shortly!',
  orderNumber: 'Order number is:',
  trackOrderMessage: 'You can track your order in "My Order" section',
  viewDetails: 'View Details',
  toastErrorOrderDetails: 'Something went wrong',
  updateOrder: 'Update Order',
  cancelOrder: 'Cancel Order',
  callCustomerService: 'Call Customer Service',
  emailCustomerServide: 'Email Customer Service',
  pleaseWait: 'Please wait',
  submit: 'Submit',
  cancelOrderReason1: 'Merchant is taking too long',
  cancelOrderReason2: 'Ordered by mistake',
  cancelOrderReason3: 'I’ve changed my mind',
  cancelOrderReason4: 'Other',
  specifyReason: 'Please specify the reason',
  orderCancelled: 'ORDER CANCELLED',
  cancelText: 'Your Order has been cancelled',
