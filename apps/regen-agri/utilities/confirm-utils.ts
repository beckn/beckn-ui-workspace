...
export const getPayloadForStatusRequest = (confirmOrderMetaDataPerBpp: any, transactionId: string) => {
  const payload: any = {
    statusRequestDto: []
  }
...
export const getPayloadForTrackRequest = (confirmOrderMetaDataPerBpp: any, transactionId: string) => {
  const payload: any = {
    trackRequestDto: []
  }
...
export const getPayloadForCancelRequest = (statusResponse: StatusResponseModel) => {
  const {
