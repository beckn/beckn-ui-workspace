  ...
  return (
    <>
      {orderHistoryList.map(orderHistory => {
        ...
        const { createdAt, bpp_id, bpp_uri, order_id, items, payments, delivery_status, transaction_id } = attributes
        ...
        return (
          <Box
            onClick={() => {
              ...
              localStorage.setItem('selectedOrderFromHistory', JSON.stringify(orderObjectForStatusCall))
