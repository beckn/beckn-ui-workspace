              ...
              <div className={style.container}>
                ...
                <div className={style.did_floating_label_content}>
                  <input
                    ...
                    onChange={handleInputChange}
                  />
                  <label className={style.did_floating_label}>{t.formCity}</label>
                  {formErrors.city && <span className={style.error}>{t[`${formErrors.city}`]}</span>}
                </div>
                ...
                <div className={style.did_floating_label_content}>
                  <input
                    ...
                    onChange={handleInputChange}
                  />
                  <label className={style.did_floating_label}>{t.formCountry}</label>
                  {formErrors.country && <span className={style.error}>{t[`${formErrors.country}`]}</span>}
                </div>
                ...
                <div className={style.did_floating_label_content}>
                  <input
                    ...
                    onChange={handleInputChange}
                  />
                  <label className={style.did_floating_label}>{t.formState}</label>
                  {formErrors.state && <span className={style.error}>{t[`${formErrors.state}`]}</span>}
                </div>
