...
describe('Product details Page Tests', () => {
  ...
  it('should render the product details component', () => {
    ...
    cy.get('.earth_support_product-product_summary_container').should('be.visible')
    cy.get('.earth_support_product-product_summary_name').should('be.visible')
  ...
  it('should render Data Sharing Modes and click On Checkbox', () => {
    cy.getByData('"product-radio"').eq(0).click()
  })
  it('should render Subscription Duration and click On Checkbox', () => {
