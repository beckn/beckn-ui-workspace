...
describe('Home Page Tests', () => {
  ...
  it('should render the homepage components', () => {
    ...
    cy.getByData(testIds.Frequently_accessed_text).should('be.visible')
  })

  it('should perform search and navigate to search results', () => {
    cy.getByData(testIds.searchInput).type('data')
  ...
  it('should Show Frequently Accessed card', () => {
    ...
    cy.getByData(testIds.Frequently_accessed_item).should('be.visible')
    ...
    cy.getByData(testIds.Frequently_Accessed_provider_name).should('be.visible')
  ...
  it('should redirect to product page when click on Frequently Accessed Card ', () => {
    cy.getByData(testIds.Frequently_accessed_item).click()
    cy.url().should('include', `${testIds.url_product}`)
  })
})
