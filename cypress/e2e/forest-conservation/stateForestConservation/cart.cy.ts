...
describe('Cart Page Tests', () => {
  ...
  context('should render When there are Items in Cart', () => {
    ...
    it('should render and display cart page with result', () => {
      ...
      cy.getByData(testIds.envirogrowth_shortDesc).should(
        'contain.text',
        'Aerial LiDAR survey on Vanapur-Girivat belt data'
      )
      cy.getByData(testIds.envirogrowth_provider).should('be.visible')
      cy.getByData(testIds.envirogrowth_provider).should('contain.text', 'Provided by Open Data Platform')
