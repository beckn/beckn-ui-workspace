...
describe('create new policy tests', () => {
  ...
  //   // cy.getByData(testIds.view_geofence).should('be.visible')

  //   // cy.getByData(testIds.draw_geofence_text).should('be.visible')
  //   // cy.getByData(testIds.clear_geofence_text).should('be.visible')
  //   // cy.getByData(testIds.clear_geofence_text).click()

  //   // cy.getByData('drow-polygon').then(el => {
  //   //   el.css('cursor', 'url("https://maps.gstatic.com/mapfiles/crosshair.cur"), auto')
  //   //   cy.wrap(el).click()
  //   // })
  //   // const polygonPoints = [
