...
describe('Reached Pick-Up Location of Taxi-Bpp (Driver Application) test cases', () => {
  before(() => {
  ...
  it('should display the top header with Reached pick-up location details visible', () => {
    ...
    cy.getByData(testIds.taxi_BPP_Reached_Pick_up_Location_button).should('exist').and('be.visible')
  })
  ...
  it('Reached pick-up location button should be clickable', () => {
