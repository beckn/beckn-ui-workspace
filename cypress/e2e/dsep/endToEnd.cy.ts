...
describe('end to end testing', () => {
  ...
  context('Billing Details and Validation', () => {
  ...
  context('Should nevigate to Home Page', () => {
    it('should have a button to go back home and navigate to home page when clicked', () => {
      cy.getByData(testIds.jobSubmitted_viewToHomePage).click()
      cy.url().should('include', '/')
    })
  })
  context('Should check three dot options', () => {
  ...
  context('Should nevigate Order History', () => {
