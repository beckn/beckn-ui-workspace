...
import { profileDetails } from '../../fixtures/INDUSTRY4.0/profile/profileDetails'
...
describe('Profile Page Tests', () => {
  ...
  it('should fill and save the profile form data and Click on Save and Continue Button Navigate on homepage', () => {
    ...
    cy.getByData(testIds.profile_form).within(() => {
      ...
      cy.intercept('POST', '/profile', { fixture: 'INDUSTRY4.0/profile/profileResponse.json' }).as('profileCall')
