...
import { billingDetails, shippingDetails } from '../../fixtures/OSC/checkoutPage/userDetails'
...
import { statusResponse } from '../../fixtures/OSC/orderDetails/statusResponse'
import { updatedShippingDetailsResponse } from '../../fixtures/OSC/orderDetails/updateShippingDetails'
...
describe('Order Details Page', () => {
  ...
  context('Should render all the different components of Order Details', () => {
    ...
    it('should render the order product details in order overview section', () => {
      cy.getByData(testIds.orderDetailspage_productName).should('contain.text', 'Cake One')
    ...
    it('should render the order details in progress summary section', () => {
      ...
      cy.getByData(testIds.orderDetailspage_orderSummaryItemName).should('contain.text', 'Cake One')
    ...
    it('should open the total item list in progress summary section on click of +1', () => {
      ...
      cy.getByData(testIds.orderDetailspage_viewMoreOrders).within(() => {
        ...
        cy.getByData(testIds.item_title).eq(0).should('contain.text', 'Cake One')
        ...
        cy.getByData(testIds.item_title).eq(1).should('contain.text', 'Cake Two')
