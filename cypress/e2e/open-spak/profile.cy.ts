...
describe('Profile Page ', () => {
  context('Consumer Profile Page Flow', () => {
    ...
    it('should Dispaly all Navigate item on Profile page', () => {
      cy.get('[data-test="My Credentials"]').should('be.visible')
      cy.get('[data-test="My Credentials"]').should('contain.text', 'My Credentials')
      cy.get('[data-test="My Trades"]').should('be.visible')
      cy.get('[data-test="My Trades"]').should('contain.text', 'My Trades')
      cy.get('[data-test="My DERs"]').should('be.visible')
      cy.get('[data-test="My DERs"]').should('contain.text', 'My DERs')
    })
    it('should Navigate to My credintial Page When click on My Credentials', () => {
      cy.get('[data-test="My Credentials"]').click()
    ...
    it('should Navigate to My DERsPage When click on My DERs', () => {
      cy.visit(`${testIds.url_base}${testIds.url_profile}`)
      cy.get('[data-test="My DERs"]').click()
