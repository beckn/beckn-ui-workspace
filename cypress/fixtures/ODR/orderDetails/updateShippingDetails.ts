import { complaintsDetails, respondentDetails } from '../../ODR/checkoutPage/userDetails'
  ...
  data: [
    {
      ...
      message: {
        ...
        fulfillments: [
          {
            ...
            customer: {
              person: {
                name: complaintsDetails.name
              },
              contact: {
                phone: complaintsDetails.mobileNumber
              }
            },
            stops: [
              {
                location: {
                  ...
                  address: complaintsDetails.address,
                  city: {
                    name: 'Bengaluru'
                  },
                  state: {
                  ...
                  area_code: complaintsDetails.pinCode
                },
                contact: {
                  phone: complaintsDetails.mobileNumber,
                  email: complaintsDetails.email
                }
              }
            ],
            tracking: false
        ...
        billing: {
          ...
          phone: respondentDetails.mobileNumber,
